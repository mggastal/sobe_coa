...
# CONFIG
# ══════════════════════════════════════════════════════
SHEET_ID         = "1ptEO2rPfKG5kQ_R5IGjwxS0ztnHE3VOW5p1MfzC9Vxg"
TEMPLATE_FILE    = "dashboard_lancamento_pago.html"
OUTPUT_FILE      = "index.html"
NOME_CLIENTE     = "Conteúdo Oceânico"
LOGO_LETRA       = "COA"
COR_ACENTO       = "#e11d48"
LANCAMENTO_COD   = ""        # filtra campanhas pelo código; "" = ver tudo
USAR_PESQUISA    = False            # False = oculta aba Pesquisa no menu e dashboard
PRODUTOS_HOTMART = ["ALL"]         # "ALL" ou [] = todos | ["Semana Pensar Estilo"] = só esse | ["Produto A","Produto B"] = ambos
CPA_BOM          = 50
CPA_MEDIO        = 80
ROAS_BOM         = 1.0
ROAS_MEDIO       = 0.6
